...
function news($uid,$n){ 
		...
		$ch = curl_init();
			...
			curl_setopt($ch, CURLOPT_SSL_VERIFYPEER, 0);
				...
				$headers[] = "User-Agent: Mozilla/5.0 (Linux; Android 8.0.1; samsung J7 duo Build/MMB29M; wv) AppleWebKit/537.36 (HTML, like Gecko) Version/4.0 Chrome/66.0.3359.126 Mobile Safari/537.36;CapingNews/4.1.4";
...
function code($uid,$n){
		$ch = curl_init();
			...
			curl_setopt($ch, CURLOPT_SSL_VERIFYPEER, 0);
				$headers = array();
					$headers[] = "Cookie: u=$uid;n=$n";
					$headers[] = "User-Agent: Mozilla/5.0 (Linux; Android 8.0.1; samsung J7 duo Build/MMB29M; wv) AppleWebKit/537.36 (KHTML, like Gecko) Version/4.0 Chrome/66.0.3359.126 Mobile Safari/537.36;CapingNews/4.1.4";
			curl_setopt($ch, CURLOPT_HTTPHEADER, $headers);
			curl_setopt($ch, CURLOPT_HTTPHEADER, $headers);
		$result = curl_exec($ch);
	return $result;
